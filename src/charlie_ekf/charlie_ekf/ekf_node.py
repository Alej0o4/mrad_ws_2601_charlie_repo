...
class SimpleEKF(Node):
    ...
    def __init__(self):
        ...
        self.topic_wheel = self.get_parameter('topics.wheel_odom').get_parameter_value().string_value
        self.topic_imu = self.get_parameter('topics.imu').get_parameter_value().string_value
