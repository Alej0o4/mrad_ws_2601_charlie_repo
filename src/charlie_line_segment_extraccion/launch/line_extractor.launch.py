...
def generate_launch_description():
    ...
    line_extractor_node = Node(
        ...
        executable='laser_line_extractor', # Nombre definido en setup.py entry_points
        name='laser_line_extractor', # Debe coincidir exactamente con el nombre raíz en el YAML
        output='screen',
        parameters=[
            config_file_path,
